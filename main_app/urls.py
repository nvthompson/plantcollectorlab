...
urlpatterns = [
    ...
    path('cats/<int:plant_id>/add_watering/', views.add_watering, name='add_watering'),
    path('cats/<int:plant_id>/assoc_container/<int:container_id>/', views.assoc_container, name='assoc_container'),
]
